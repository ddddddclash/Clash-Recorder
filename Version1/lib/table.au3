...
; #FUNCTION# ;===============================================================================
; Name...........: _GUICtrlTableEdit_Create
; Description ...: Creates a 'table' of Input controls, and preps the 'border array'
; Syntax.........: _GUICtrlTableEdit_Create($iLeft, $iTop, $iWidth, $iHeight, $iRows, $iColumns[, $iGapWidth = 1])
; Parameters ....: $iLeft - Horisontal position of first cell
;                  $iTop - Vertical position of first cell
;                  $iWidth - Initial width of each cell
;                  $iHeight - Initial height of each cell
...
; Author ........: dddddd.clash
; ===========================================================================================
Func _GUICtrlTableEdit_Create($iLeft, $iTop, $iWidth, $iHeight, $iRows, $iColumns, $iGapWidth = 1)
    ...
    For $i = 1 To $iRows
        For $j = 1 To $iColumns
            $array[$i][$j] = GUICtrlCreateInput("", $iLeft + $iCurrBoxLeft, $iTop + $iCurrBoxTop, $iWidth, $iHeight)
            GUICtrlSetBkColor(-1, 0xFFFFFF)
            $iCurrBoxLeft += $iWidth + $iGapWidth
        Next
        $iCurrBoxLeft = 0
